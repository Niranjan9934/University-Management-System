...
public class AboutUs extends JFrame {
    ...
    public AboutUs() {
        ...
        JLabel l6 = new JLabel("Developed By : Niranjan Kumar");
        l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
        l6.setBounds(70, 198, 600, 35);
        contentPane.add(l6);

        JLabel l7 = new JLabel("Contact Number: +91 7635029580");
        l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
        l7.setBounds(70, 260, 600, 34);
        contentPane.add(l7);

        JLabel l8 = new JLabel("Contact : vinay@knowledgegate.in");
        ...
        JLabel l10 = new JLabel("Phone - +91 6207147847");
